...
const products = [
  ...
  { _id: prod1Id, name: 'REAUX Whey Protein Isolate 1kg', description: 'Premium whey protein isolate with 28g protein per scoop. Zero added sugar.', price: 2499, compareAtPrice: 2999, images: ['https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=800'], category: 'supplements', stock: 120, visibility: 'all', isActive: true, createdBy: admin1Id, createdAt: now, updatedAt: now },
  { _id: prod2Id, name: 'BCAA Powder 300g - Berry Blast', description: 'Branch chain amino acids (2:1:1 ratio) for improved recovery and endurance.', price: 999, compareAtPrice: 1299, images: ['https://images.unsplash.com/photo-1704650311140-aba27da8623d?w=800'], category: 'supplements', stock: 80, visibility: 'all', isActive: true, createdBy: admin1Id, createdAt: now, updatedAt: now },
  { _id: prod3Id, name: 'REAUX Shaker Bottle 700ml', description: 'BPA-free shaker bottle with wire whisk ball. Leak-proof lid.', price: 349, compareAtPrice: 499, images: ['https://images.unsplash.com/photo-1553531580-8f1950e53700?w=800'], category: 'accessories', stock: 300, visibility: 'all', isActive: true, createdBy: admin2Id, createdAt: now, updatedAt: now },
  // visibility: 'admin' — gym equipment & bulk supplies (admin/superadmin only)
  { _id: prod4Id, name: 'Commercial Treadmill Belt Replacement', description: 'Heavy-duty treadmill belt for commercial gym treadmills. 2-ply, anti-static.', price: 8999, compareAtPrice: 11999, images: ['https://images.unsplash.com/photo-1576678927484-cc907957088c?w=800'], category: 'equipment', stock: 10, visibility: 'admin', isActive: true, createdBy: superAdminId, createdAt: now, updatedAt: now },
  { _id: prod5Id, name: 'Gym Sanitizer & Disinfectant 5L', description: 'Industrial-grade surface cleaner for gym equipment. Kills 99.9% germs.', price: 1499, compareAtPrice: 1999, images: ['https://images.unsplash.com/photo-1584515933487-779824d29309?w=800'], category: 'supplies', stock: 50, visibility: 'admin', isActive: true, createdBy: superAdminId, createdAt: now, updatedAt: now },
  // visibility: 'user' — exclusive member offers
  { _id: prod6Id, name: 'REAUX Members-Only Training Gloves', description: 'Premium leather training gloves exclusively for REAUX members. Wrist wrap support.', price: 899, compareAtPrice: 1499, images: ['https://images.unsplash.com/photo-1517344884509-a0c97ec11bcc?w=800'], category: 'accessories', stock: 150, visibility: 'user', isActive: true, createdBy: admin1Id, createdAt: now, updatedAt: now },
];
