...
const gyms = [
  {
    ...
    logo: 'https://api.dicebear.com/7.x/initials/svg?seed=RFD',
  ...
  },
  {
    ...
    logo: 'https://api.dicebear.com/7.x/initials/svg?seed=RFM',
  ...
  },
  {
    ...
    logo: 'https://api.dicebear.com/7.x/initials/svg?seed=RFB',
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const reels = [
  { _id: oid(), author: user1Id, videoUrl: 'https://example.com/reels/deadlift-pr.mp4', caption: '180kg deadlift PR! #deadlift #gym #strength', likes: [user2Id, user3Id], likesCount: 2, createdAt: new Date('2026-02-01'), updatedAt: new Date('2026-02-01') },
  { _id: oid(), author: user2Id, videoUrl: 'https://example.com/reels/5k-run.mp4', caption: 'First 5K under 25 min! #running #cardio', likes: [user1Id, admin2Id], likesCount: 2, createdAt: new Date('2026-02-02'), updatedAt: new Date('2026-02-02') },
  { _id: oid(), author: user3Id, videoUrl: 'https://example.com/reels/bench-press.mp4', caption: 'Bench press form check - 100kg x 5. Any tips? #benchpress #formcheck', likes: [user1Id], likesCount: 1, createdAt: new Date('2026-02-03'), updatedAt: new Date('2026-02-03') },
  { _id: oid(), author: admin1Id, videoUrl: 'https://example.com/reels/gym-tour.mp4', caption: 'Quick tour of REAUX Fitness Delhi! Come check us out. #gymtour #reauxfitness', likes: [user1Id, user2Id, user3Id], likesCount: 3, createdAt: new Date('2026-02-04'), updatedAt: new Date('2026-02-04') },
];
...
const products = [
  {
    ...
    price: 2499,
    compareAtPrice: 2999,
    images: ['https://images.unsplash.com/photo-1593095948071-474c5cc2c1a0?w=400'],
  ...
  },
  {
    ...
    price: 999,
    compareAtPrice: 1299,
    images: ['https://images.unsplash.com/photo-1594381898411-846e7d193883?w=400'],
    category: 'supplements',
    stock: 80,
    isActive: true,
    createdBy: admin1Id,
  ...
  },
  {
    ...
    price: 349,
    compareAtPrice: 499,
    images: ['https://images.unsplash.com/photo-1609692814867-b3ea3e3f8bbb?w=400'],
